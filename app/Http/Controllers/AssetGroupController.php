...
class AssetGroupController extends Controller
{
    ...
    public function show(AssetGroup $assetGroup)
    {
        ...
        $assets = isSuperadmin() ? $assetGroup->assets()->orderBy('sbu_id', 'asc')->orderBy('pcs_date', 'desc')->get() : $assetGroup->assets()->where('sbu_id', userSBU())->orderBy('sbu_id', 'asc')->orderBy('pcs_date', 'desc')->get();
