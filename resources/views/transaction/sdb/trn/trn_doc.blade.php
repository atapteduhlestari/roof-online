...
@section('container')
    ...
    <div class="container-fluid">
        ...
        <div class="my-4">
            <form action="/trn-sdb/doc/store" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control not-allowed" value="{{ $doc->doc_name }}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('take_out') is-invalid @enderror" name="take_out"
                                value="{{ old('take_out', $doc->trnSDBDetail->take_out ?? null) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="back_in"
                                value="{{ old('back_in', $doc->trnSDBDetail->back_in ?? null) }}">
                        </div>
                    </div>
